/**
 * Default system prompts for fill-card (mirrors server's buildFillCardSystemPrompt).
 * Used to pre-fill the prompt editor on the client so user can customize before sending.
 */
...
export function getDefaultFillCardSystemPrompt(
  ...
  if (nodeType === "transformation") {
    return `Ты — инженер-технолог химической и промышленной технологии.
