...
export interface CustomNodeData {
   ...
   *
   * От description отличается тем, что говорит НАЗНАЧЕНИЕ, а не устройство:
   * описание может уйти в стадии и оборудование, а это — зачем шаг нужен.
   */
  mainPurpose?: string;
  /**
   * Оговорки к шагу — списком.
   *
   * Живут отдельно от описания: описание говорит, как процесс устроен, а это
   * — чем он на практике бывает иным. Смешать их значило бы выдать оговорку
   * за правило.
   */
  notes?: string[];
