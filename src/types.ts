...
export interface CustomNodeData {
  ...
  /**
   * Число производителей продукта, найденных в ГИСП. Подключения к базе пока
   * нет, поэтому поле никем не заполняется — бейдж на узле появится, только
   * когда данные начнут приходить.
   */
  gispProducers?: number;
  /** Продукт подтверждён в ГИСП — учитывается счётчиком в строке состояния. */
