...
export interface InitialGraphStateI {
  ...
  needsFreshSources: Record<
    string,
    {
      ...
      // 'manual' — продукт добавлен пользователем вручную: он не выведен из
      //   источников родителя, поэтому наследовать их нельзя — обобщение шло
      //   бы по материалу, который об этом продукте ничего не говорит.
