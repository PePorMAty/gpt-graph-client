  ...
  return (
    <div className={styles.shell}>
      ...
      <div className={styles.main}>
        {/* Рельс — инструменты полотна. В библиотеке им нечего делать, и её
            список графов занимает освободившееся место. */}
        {isGraphScreen && (
          <LeftRail active={section} onSelect={handleRailSelect} />
        )}
